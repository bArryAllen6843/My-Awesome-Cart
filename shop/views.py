...
def searchMatch(query, item):
    ...
    if query in item.product_name.lower() or query in item.category.lower() or query in item.desc.lower() or \
            query in item.subcategory.lower():
        return True
    else:
        return False
